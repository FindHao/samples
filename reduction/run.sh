...
time hpcrun -o hpctoolkit-reduction-measurements -ck HPCRUN_SANITIZER_MEM_VIEWS=10 -ck HPCRUN_SANITIZER_PC_VIEWS=10 -e gpu=nvidia,sanitizer ./reduction --type=double --n=1024 &>log
hpcstruct ./reduction
